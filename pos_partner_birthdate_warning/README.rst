...
verification system. When a customer is selected and their age is **less
than or equal** to the **"Age Warning"** threshold set in the POS
configuration, a warning popup will appear. The customer's name and age
(e.g., John DOE (14 y)) will be displayed in **red** on the POS
interface to alert the cashier.
...
- **Result**: A warning popup appears on the POS interface, displaying
  the customer's name and age in red to alert the cashier.
...
2. Select a customer The cashier will see a warning popup appear, or
   not.
3. Continue the sale
